...
import com.mndk.tilemapper.util.MathUtils;
...
public class TileImageData {
    ...
    /**
     * Returns the corresponding RGB color from an image (nearest-neighbor)
     * @param x The x coordinate of the image (0 ~ 1)
     * @param y The y coordinate of the image (0 ~ 1)
     * @return The RGB value, or null if outside bounds
     */
    ...
    /**
     * Returns the corresponding RGB color from an image (bicubic interpolation)
     * @param x The x coordinate of the image (0 ~ 1)
     * @param y The y coordinate of the image (0 ~ 1)
     * @return The RGB value, or null if outside bounds
     */
    ...
    private static RGBColorDouble rgbInterpolation(
            Integer rgb0, Integer rgb1, Integer rgb2, Integer rgb3, double t) {
    ...
    private static RGBColorDouble rgbInterpolation(
            RGBColorDouble rgb0, RGBColorDouble rgb1, RGBColorDouble rgb2, RGBColorDouble rgb3, double t) {
